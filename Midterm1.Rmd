...
## Midterm 1: Due Tuesday February 20, 2024

**1) Summarize your data. For example, what are the average and standard deviation of height and wages. Assuming height is normally distributed draw the probability distribution curve for height. (10 points)**
...
**2) Create a scatterplot with height on the horizontal axis and wages on the vertical axis. Do any of the observations stand out on this graph? Why? (5 points)**
...
**3) Create another data file, using your existing data, but exclude observations that have wages that exceed 400 pound sterling per hour and/or observations that have a height value of less than 40 inches. Summarize this new data set (e.g., what happens to the number of observations and the average height and wage). (15 points) **
...
**4) Assuming wages are the dependent variable and height is the independent variable, estimate $\beta_0$ and $\beta_1$ for the data set that includes all the observations. Re-estimate the pararmeters employing the data set created in part (3) of this exam. Summarize your estimates in a stargazer table. (15 points)**
...
**5)  a) Interpret the coefficients for the full sample and the truncated sample. (15 points) <br/> **
...
**5) b) Calculate the t-statistics on the coefficients and interpret them for the full sample and the truncate sample. (10 points)**
...
**6) Explain what the p-values mean for the 2 estimate coefficients for the subsample. (10 points) **
...
**7) Show how to calculate a 95\% confidence interval for the coefficient on height. Calculate this for the full sample and then for the truncated sample. What can be learnt from this? (10 points)**
...
**8) Do we accept or reject the null hypothesis that $\beta_1 =0$ for $\alpha = .01$ and a two-sided alternative? Explain your answer. (10 points)**
